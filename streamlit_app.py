...
# ==============================================================================
# 6. INTELIGÊNCIA ARTIFICIAL (V95 - BLINDAGEM DE CONTEÚDO)
# ==============================================================================
...
# --- FUNÇÃO DALL-E 3 (AGORA INSPIRACIONAL) ---
def gerar_imagem_dalle_integrada(api_key, dados_aluno, texto_estrategias):
    ...
    try:
        ...
        prompt_dalle = f"""
        A creative concept art illustration in Pixar/Disney style.
        Theme: {hf}. 
        Subject: A young student character (approx age for {serie}) looking confident and heroic.
        Environment: A magical study room or fantasy world blending school elements with {hf}.
...
def consultar_gpt_pedagogico(api_key, dados, contexto_pdf="", regenerar=False):
    ...
    try:
        ...
        # PROMPT BLINDADO PARA EVITAR VAZAMENTO DE DADOS TÉCNICOS
        prompt_sys = f"""
        ...
        (Gere um guia visual em Markdown para o aluno. REGRAS RÍGIDAS DE BLOQUEIO:
        1. NÃO mencione CID, Diagnósticos, Remédios ou Problemas Comportamentais aqui.
        2. NÃO mencione 'Barreiras'.
        3. Use APENAS linguagem positiva, de herói e superpoderes).
...
class PDF_Game_Board(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "MEU MAPA DE PODERES E MISSOES", 0, 1, 'C')
...
def gerar_pdf_final(dados, tem_anexo):
    ...
    if dados['ia_sugestao']:
        ...
        texto_tecnico = dados['ia_sugestao'].split("[MAPA_TEXTO_GAMIFICADO]")[0]
